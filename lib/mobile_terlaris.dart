...
class MobileTerlaris extends StatefulWidget {
  const MobileTerlaris({Key? key}) : super(key: key);

  @override
  State<MobileTerlaris> createState() => _MobileTerlarisState();
}

class _MobileTerlarisState extends State<MobileTerlaris> {
